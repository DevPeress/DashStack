  ...
  return (
    <>
      ...
      <Pagina>
        ...
        <button className="absolute md:right-[2.7vw] lg:right-[2.7vw] md:top-[3vw] lg:top-[2vw] md:w-[12vw] lg:w-[7.656vw] md:h-[4vw] lg:h-[2.5vw] bg-[#4379EE] font-bold md:text-[1.4vw] lg:text-[0.729vw] text-[#FFFFFF] rounded-[0.313vw] hover:scale-115 select-none" onClick={alterarTipo}>{tipo ? "Voltar" : "Novo membro"}</button>
        {tipo ? 
          <>
            <Contratar />
          </>
